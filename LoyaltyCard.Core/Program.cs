...
namespace LoyaltyCard.Core
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            var userId = Guid.Parse("2bdc5526-c9ce-402B7-b4b0-976b11707d12");
    
            //var streamName = GetStreamName<User>(userIB);

            //var handler = new CustomerService(await GetConnection(), streamName);
